  ...
  return (
    <div className="">
      <Image
        ...
        height={250}
      />
      <div className="-mt-2 border-b border-l border-r p-3 shadow-sm rounded-bl-md rounded-br-md border-lightGray">
        <p className="pb-2 text-lg text-blue font-medium w-full truncate">{ title }</p>
